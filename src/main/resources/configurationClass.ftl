...
/**
* This class was automatically generated by connector-base-config-plugin. It is not ideal to modify
* this file, as subsequent builds of this project will overlay your changes in this file. Instead,
* modify the configuration.structure.yml in this project.
*/
<#if internalItems??>
@ConfigurationClass(
    skipUnsupported = true,
    ignore={${internalItems}})
<#else>
