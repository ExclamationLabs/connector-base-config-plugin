            ...
            simpleProcessor.configurationItems =
                    [new ConfigurationItem.Builder()
                     ...
                     new ConfigurationItem.Builder()
                             ...
                             .defaultValue(5123456)
                             .validations(['@Min(1)', '@Max(10)'])
                             .required(true)
                             .type(ConfigurationItemType.LONG).build(),
                     new ConfigurationItem.Builder()
                             .name('item2', ['test'])
                             .displayText('Display text item 2')
                             .defaultValue(-4561111.232)
                             .validations(['@Min(1)', '@Max(14)'])
                             .required(true)
                             .type(ConfigurationItemType.FLOAT).build(),
                     new ConfigurationItem.Builder()
                             .name('item3', ['test'])
                             .displayText('Display text item 3')
                             .defaultValue(123789)
                             .validations(['@Min(1)', '@Max(10)'])
                             .required(true)
                     ...
                     new ConfigurationItem.Builder()
                             ...
                             .required(false)
                             .confidential(true)
                             .helpText('HelpText item 4')
                             .type(ConfigurationItemType.STRING).build(),
                     new ConfigurationItem.Builder()
                             .name('item5', ['test'])
                             .required(true)
                             .defaultValue('Hello World')
                             .helpText('HelpText item 5')
                             .type(ConfigurationItemType.STRING).build(),
                     new ConfigurationItem.Builder()
