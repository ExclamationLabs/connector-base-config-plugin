...
"""
    ...
    def 'happyPath w/ behavior and unrecognized behaviors'() {
        given:
        def happyData = """
---
name: 'myconn'
...
"""
        ...
        1 == 1
        processor.behaviors
        1 == processor.behaviors.size()
        'DeepGet' == processor.behaviors[0].name()
    }

    def 'sadPath w/ invalid behavior boolean value'() {
        given:
        def happyData = """
---
name: 'myconn'
...
"""
    ...
    def 'sadPath w/ invalid behavior type'() {
        given:
        def happyData = """
---
name: 'myconn'
